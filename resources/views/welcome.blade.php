    ...
    <body class="antialiased">
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="card-body">
                   <center> <h1>Signup Post Api</h1> <a href="/tracking/public/api/user-list">User List Get API</a></center><br>
                    <form method="POST" action="{{ url('api/user-signup') }}">
        ...
        <input type="hidden" name="roleStatus" value="1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="current_location_addressline">
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <center> <h1>Login Post Api</h1>  </center>
                ...
                <div class="card-body">
                    <center> <h1>User Location Update Api</h1><a href="/tracking/public/api/user/location">User Location Get API</a></center><br>
                <form method="POST" action="{{ url('api/user/location/update') }}">
                                   
                                    <div class="form-group row">
                                        <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('User ID') }}</label>
                                        <?php $userlists= \App\Models\User::all();?>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('User Address') }}</label>
